This directory contains the Phoenix reference implementation of Planning Poker.
Run all Mix commands from `elixir/`. The active Go/Svelte replacement lives in `../go/`.
